...
// Helpers: Geometry
IMGUI_API ImVec2     ImQuadBezierCalc(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, float t);                                         // Cubic Bezier
IMGUI_API ImVec2     ImCubicBezierCalc(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, float t);                                         // Cubic Bezier
...
struct IMGUI_API ImDrawListSharedData
{
    ...
    float           CurveTessellationTol;       // Tessellation tolerance when using PathCubicBezierCurveTo()
